...
class ClaseSimon(Canvas):
    ...
    def __init__(self, master=None, **options):
        ...
        ##texto
        self.create_text([[195, 160]], text='SIMÓN', font="arial 20")
        ...
        c8 = [[187, 222, ], [213, 248]]
        self.create_oval(c8, fill='pink')
        c9 = [[237, 222, ], [263, 248]]
        self.create_oval(c9, fill='blue')

        var = IntVar()
        ##Entry
        en = Entry(self, width=int(w / 100), bg="black", textvariable=var, fg="red")
        ...
        # f1=homogenize(linea)
        # f2=np.dot(f1,f).tolist()
        # dehomogenize(f2)
        # print(f2)
        # l=canvas.create_line(f2,fill='yellow')
        ...
        # homogenize(linea)
        # l2=(np.dot(linea, transform).tolist())
        # dehomogenize(l2)
        # canvas.create_line(l2,fill="yellow")
        ##poligono
        ...
        self.dehomogenize(pol2)
        p1=self.create_polygon(pol2, fill="green",activefill="lightgreen")
